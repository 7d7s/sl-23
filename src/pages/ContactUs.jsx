...
import ContactImg from '../assets/img/page-header-bg.jpg';
...
function ContactUs() {
  ...
  return (
    <>
      <Banner title="Contact" subtitle="Home / Contact" backgroundImage={ContactImg}/>
      ...
      <div className="container-fluid bg-light-101 px-0 contact-margin-padding">
        <div className="container-fluid">
          <div className="row justify-content-end position-relative">
            ...
            <div className="col-xl-5 col-lg-12 z-1 form-margin-padding">
            ...
            <div className="col-xl-6 col-lg-12 p-0 position-relative">
              ...
              <div className="contact_info">
                ...
                <div className="contact_info__content">
                  <h4>Our Location:</h4>
                  <p> Sleme, I-102, 2<sup>nd</sup> Floor, Block I, Kirti Nagar, Delhi, 110015</p>
                </div>
              </div>
            </div>
          </div>
